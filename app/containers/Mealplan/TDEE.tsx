...
// TDEE Component
class TDEEComponent extends React.Component<AllProps, State> {
	...
	render() {
		return (
			<Grid fluid>
				<Row center="xs">
					<Col xs>
						<span>This is the Mealplan TDEE form for a person in a mealplan, page.</span>
					</Col>
				</Row>
			</Grid>
		);
...
export const TDEEContainer = connect<MyStateProps, MyDispatchProps, MyOwnProps>(
	mapStateToProps,
	mapDispatchToProps
)(TDEEComponent);
