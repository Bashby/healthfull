...
const BOTTOM_NAVIGATION_INDEX: number = 1;

// GroceryList Component
class GroceryListComponent extends React.Component<AllProps, State> {
	...
	render() {
		return (
			<Grid fluid>
				<Row center="xs">
					<Col xs>
						<span>This is the GroceryList page.</span>
					</Col>
				</Row>
			</Grid>
		);
...
export const GroceryListContainer = connect<MyStateProps, MyDispatchProps, MyOwnProps>(
	mapStateToProps,
	mapDispatchToProps
